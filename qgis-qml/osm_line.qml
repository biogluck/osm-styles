...
<qgis simplifyMaxScale="1" minScale="1e+8" labelsEnabled="1" readOnly="0" maxScale="0" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.2-Madeira" styleCategories="AllStyleCategories" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{7b119d4a-0eb5-413f-8a65-cda23c13ffcd}">
      <rule scalemindenom="1000" scalemaxdenom="200000" filter=" &quot;waterway&quot;  IN ('river',  'drain', 'stream' , 'canal' , 'ditch' , 'riverbank' ) " symbol="0" label="waterways" key="{59b2503e-2464-474d-922e-a73b48f3e1d2}"/>
      <rule scalemindenom="200000" scalemaxdenom="2000000" filter=" &quot;waterway&quot;  IN ('river',  'canal' ) AND &quot;name&quot; IS NOT NULL" symbol="1" label="waterways" key="{42c8fe9e-9baf-400d-abf8-1c310f89c123}"/>
      <rule scalemindenom="1000" scalemaxdenom="2000000" filter="&quot;railway&quot;='rail' AND &quot;service&quot; IS NULL" symbol="2" label="railways" key="{f4ac7644-4fd7-4363-aaf4-ae15d9900901}"/>
      <rule scalemaxdenom="100000" filter="&quot;highway&quot; IN ('path', 'bridleway', 'footway', 'pedestrian')" symbol="3" label="path" key="{161d0ee0-55c2-4e3e-af44-6fef6be7203b}"/>
      <rule scalemaxdenom="200000" filter="&quot;highway&quot; IN ('track', 'unclassified', 'residential', 'road','service', 'living_street')" symbol="4" label="other roads" key="{0ce79a54-e0d6-42ac-bb63-93369f3bce6d}"/>
      <rule scalemindenom="-2147483648" scalemaxdenom="200000" filter="&quot;highway&quot; IN ('secondary')" symbol="5" label="secondary" key="{91254b33-3d9a-4f3d-b97b-1f7593566649}"/>
      <rule scalemaxdenom="200000" filter="&quot;highway&quot; IN ('motorway', 'motorway_link', 'trunk', 'trunk_link','primary','primary_link')" symbol="6" label="primary" key="{0ce79a54-e0d6-42ac-bb63-93369f3bce6d}"/>
      <rule scalemindenom="200000" scalemaxdenom="1000000" filter="&quot;highway&quot; IN ('secondary')" symbol="7" label="secondary" key="{49c507cc-2242-42e7-a415-2735648cce68}"/>
      <rule scalemindenom="200000" scalemaxdenom="1000000" filter="&quot;highway&quot; IN ('motorway', 'trunk' ,'primary')" symbol="8" label="primary" key="{7cf309bd-a9e9-460d-83f9-3a222a4dc8ac}"/>
      <rule scalemindenom="1000000" scalemaxdenom="2000000" filter="&quot;highway&quot; IN ('motorway', 'trunk' ,'primary')" symbol="9" label="primary" key="{967bb192-1875-406a-99c2-d8b5d5b8f592}"/>
      <rule scalemindenom="2000000" filter="&quot;highway&quot; IN ('motorway', 'trunk')" symbol="10" label="primary" key="{d08ffd04-e956-4a68-87d9-28bb3081ac75}"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" type="line" alpha="1">
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          ...
          <prop k="line_color" v="158,216,228,255"/>
      ...
      <symbol name="3" clip_to_extent="1" type="line" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="1" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="128,64,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.3"/>
          <prop k="line_width_unit" v="Pixel"/>
          <prop k="offset" v="0"/>
      ...
      <symbol name="5" clip_to_extent="1" type="line" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="2" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="255,231,168,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <labeling type="rule-based">
    <rules key="{156c9113-56da-46d1-9cf8-43b35add306f}">
      <rule scalemindenom="1000" scalemaxdenom="500000" filter="&quot;waterway&quot; IN ('river','canal','riverbank')" description="water_labels" key="{79c361bc-631d-4479-b7f3-5d60cb5c83c2}">
        <settings>
          <text-style useSubstitutions="0" fontItalic="0" textOpacity="1" previewBkgrdColor="#ffffff" fieldName="name" isExpression="0" fontFamily="Noto Sans" fontUnderline="0" fontStrikeout="0" namedStyle="Normal" textColor="31,120,180,255" fontWordSpacing="0" fontWeight="50" fontSize="7" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontCapitals="0" multilineHeight="1" fontLetterSpacing="0" fontSizeUnit="Point">
          ...
          <text-format wrapChar="" rightDirectionSymbol=">" formatNumbers="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" addDirectionSymbol="0" plussign="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" multilineAlign="0" placeDirectionSymbol="0" decimals="3"/>
          <placement rotationAngle="0" priority="5" offsetType="0" quadOffset="4" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="200" preserveRotation="1" distMapUnitScale="3x:0,0,0,0,0,0" placement="3" placementFlags="14" offsetUnits="MapUnit" repeatDistanceUnits="MM" dist="0" distUnits="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="20" centroidWhole="0" yOffset="0" xOffset="0" maxCurvedCharAngleOut="-20" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering limitNumLabels="0" zIndex="0" obstacleType="0" mergeLines="0" scaleMin="1" fontLimitPixelSize="0" obstacleFactor="1" displayAll="0" fontMaxPixelSize="10000" fontMinPixelSize="3" maxNumLabels="2000" minFeatureSize="0" drawLabels="1" scaleMax="10000000" scaleVisibility="0" obstacle="1" labelPerPart="0" upsidedownLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
                <Option name="RepeatDistance" type="Map">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Pie">
    <DiagramCategory penColor="#000000" enabled="0" penAlpha="255" minScaleDenominator="0" maxScaleDenominator="1e+8" height="15" sizeType="MM" scaleDependency="Area" scaleBasedVisibility="0" opacity="1" diagramOrientation="Up" minimumSize="0" backgroundColor="#ffffff" backgroundAlpha="255" width="15" penWidth="0" lineSizeScale="3x:0,0,0,0,0,0" sizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" barWidth="5" labelPlacementMethod="XHeight" rotationOffset="270">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
      <attribute field="" color="#000000" label=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings obstacle="0" dist="0" placement="2" linePlacementFlags="2" showAll="1" zIndex="0" priority="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
